...
def populate():    
    ...
    household_appliances = [{'product_name':'Washing Machine',
                             ...
                             'quantity': 62,
                             'average_rating': 5,
                             'image_reference': 'washing_machine.jpg',
                             'seller': test_user,
                             'views': 1284,
                             'date_added': date.today,
    ...
    hardware = [{'product_name':'3200 Series Noveed GPU',
                 ...
                 {'product_name':'HJXMDASH42 AZOOS Motherboard',
                  ...
                  'quantity': 47,
                  'average_rating': 3.8,
                  'image_reference': 'motherboard.jpg',
                  'seller': test_user,
                  'views': 3208,
                  'date_added': date.today,
    ...
    misc = [{'product_name':'CardboardBox Controller',
             ...
             'quantity': 37,
             'average_rating': 4.2,
             'image_reference': 'controller.jpg',
             'seller': test_user,
             'views': 273,
             'date_added': date.today,
